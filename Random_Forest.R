...
Dataset<-RF.Anal(Dataset, 500,7,1,"Type","OTU")
Dataset<-PlotRF.Classify(Dataset, 15, "rf_cls_0","png", width=NA)
Dataset<-RF.Anal(Dataset, 500,7,1,"Type","OTU")
Dataset<-PlotRF.VIP(Dataset, 15, "rf_imp_0","png", width=NA)
Dataset<-PlotRF.Classify(Dataset, 15, "rf_cls_1","png", width=NA)
Dataset<-PlotRF.VIP(Dataset, 15, "rf_imp_1","png", width=NA)
